...
Domain.Text.Text = "Exe hub Beta - 1.1"
...
Domain.Content.Text = "Fellow exploit! Exe hub has found an exploit for this specific game."
...
Domain.VersionText2.Text = "- Fixed few things"
